...
public class ConnectionSuggestion {
    ...
    /**
     * Representa o resultado de uma sugestão de conexão,
     * armazenando o nome do perfil e a quantidade de amigos em comum.
     */
    public record SuggestionResult(String profileName, int mutualFriends) {}
}
